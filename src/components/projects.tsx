  ...
  const projects = [
    {
      ...
      solutions: [
        "Added background/reflective augmentations to the dataset and tuned confidence/NMS thresholds; masked some regions to reduce false positives.",
        "Auto-exposure lock + fixed white balance presets; optional ring-light bias.",
    ...
    },
    {
      ...
      duration: "Done",
      keyObjectives: [
        "Detect buried metallic signatures",
      ...
      results: ["Field-detectable signatures", "Baseline classification pipeline"],
      category: "ai"
    },
    {
      id: 3,
      title: "AI I-Spy",
      description:
        "AI game of I-Spy that detects objects in real time and guides players with spatial cues.",
      fullDescription:
        "An educational, AI-driven twist on 'I Spy'. Built on Raspberry Pi 5 with Python + YOLO and a laser-based mapping mechanism for spatial awareness. Recognizes >20 object categories with >95% accuracy in tests and verifies player responses.",
      image:
      ...
      duration: "Done",
      keyObjectives: [
        "Deliver >95% detection accuracy in classroom lighting",
      ...
      solutions: [
        ...
        "Auto-gain and exposure presets plus contrast normalization for consistent inputs.",
        "Calibrated laser line with homography; fused centroid history to dampen jitter for stable guidance."
      ],
      results: [">95% detection accuracy", "Interactive gameplay loop", "Real time laser pointer"],
      category: "ai"
    },
    {
      id: 4,
      ...
      description:
        "Heavy-lift hexacopter with Pixhawk, GPS, and autonomous missions for landmine detection, wildfire support and organ transport.",
      fullDescription:
        "Carbon-fiber hexacopter with Pixhawk flight controller and QGroundControl mission planning. Allows different payloads from a landmine detection system to a localized water sprinkler for wildfire hot spots or a stabilized transport for temperature-sensitive medical organs. It focuses on endurance, safety failsafes, and modular payloads.",
      image:
    ...
    },
    {
      ...
      fullDescription:
        "A front-yaw tricopter integrated into a foam F-22 airframe to perform realistic flyovers at events. Custom mixer enables precise yaw authority from the front. Possibility of onboarding a stabilized camera for dynamic, broadcast-style footage.",
      image:
        `${import.meta.env.BASE_URL}Photos/F22Flyover.jpg`,
      tags: ["Custom Mixer", "Betaflight", "Yaw Dynamics", "Cinematic Flight", "3D Printed Mounts"],
      teammates: ["Khisa-Lee Lebrun", "Braden Fadal"],
      demo: "#",
      duration: "Done",
      keyObjectives: [
      ...
      solutions: [
        ...
        "Surface smoothing and minimal external protrusions.",
    ...
    },
    {
      ...
      description:
        "Cross plateform application to diagnose and optimize Wi-Fi.",
      fullDescription:
      ...
      tags: ["Network Analysis","2.4 GHz", "Visualization", "React", "Data Pipelines"],
      teammates: ["Khisa-Lee Lebrun", "Boyd Paxton", "Nicholas Woodward"],
      demo: "#",
      duration: "Done",
      keyObjectives: [
        "Render real-time heat maps",
        "Highlight interferers",
        "Support mobile diagnostics in the field"
      ],
      challenges: ["Real-time rendering", "Calibration"],
      solutions: [  
    ...
    },
    {
      ...
      description:
        "Cross-platform app for checklists, flight logs, and incident reporting.",
      fullDescription:
        "Streamlines compliance and safety workflows for drone operators. Features pre/post-flight checklists, real-time logging, local regulations, and integrated docs. More than 20 active users. Fun story: I rescued a seagull while working there, making it the mascot and the logo of the application.",
      image:
    ...
    },
    {
      ...
      fullDescription:
        "Farewell gift for roommates: an NFC tag in a custom frame opens a mobile-friendly web app showing random memories, photos, quotes, playlists, videos. Designed in Figma with a lightweight front/back-end and an emphasis on emotional continuity via tangible tech.",
      image:
    ...
    },
    {
      ...
      description:
        "Printed mount for inductive sensor on the landmine drone",
      fullDescription:
        "CAD + 3D print of sensor coil holder with alignment features, adjustable height, and strain-relieved routing. Designed for quick swaps during field tests.",
      image:
       `${import.meta.env.BASE_URL}Photos/InductCoil.png`,
      tags: ["3D Printing", "CAD", "Rapid Iteration"],
      teammates: ["Khisa-Lee Lebrun"],
      demo: "#",
      duration: "Done",
      keyObjectives: [
      ...
      challenges: [ "Cable management"],
      solutions: [
        "Integrated channels and keyed alignment features."
      ],
    ...
    },
    {
      ...
      fullDescription:
        "Measured game components and designed snap-fit printed boxes with compartments. Improves longevity and portability",
      image:
      ...
      challenges: ["Dimensional tolerance", "Hinge durability"],
      solutions: [
    ...
    },
    {
      ...
      description:
        "Kitchen organizer with LEGO styling to match my existing shaker set",
      fullDescription:
      ...
      challenges: ["Food-adjacent cleanliness", "Stud fit"],
      solutions: [
      ...
      results: ["Stable rack", "Themed aesthetic"],
      category: "3d"
    },
    {
      id: 14,
      ...
      solutions: [
        "Set up a consented capture pipeline: take daily running videos from diverse people (ages, body types, shoes, terrains) using multiple phones.",
        "Start native on iOS to learn the stack: Swift + AVFoundation for stable video capture, CoreMotion for IMU, and CoreML for on-device inference.",
        "Use semi-auto labeling: run MediaPipe Pose/YOLO to pre-keypoint frames, then refine in CVAT/Label Studio.",
      ],
      results: [
        "Built a private dataset with 50+ runners",
        "Annotated 500+ frames with pose keypoints and fault labels."
      ],
      category: "ai"
    }
  ];
